...
public class MySQLGrade implements DAOGrade{
    ...
    public ArrayList<Grade> queryAll() {
        ...
        try{
            ...
            String sql = "SELECT A.description,A.weight, A.active, C.*, D.* FROM Grade A INNER JOIN StudentXGrade B ON A.idGrade=B.idGrade INNER JOIN Student C "
                    + "ON B.idStudent=C.idStudent INNER JOIN CourseXSchedule D ON A.idCourseXSchedule=D.idCourseXSchedule ";
